...
class CrmNoteController extends Controller
{
    ...
    public function create()
    {
        ...
        $court_cases = CourtCase::all()->pluck('case_name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.crmNotes.create', compact('customers', 'court_cases'));
    }
    ...
    public function edit(CrmNote $crmNote)
    {
        ...
        $crmNote->load('customer', 'court_case');

        return view('admin.crmNotes.edit', compact('customers', 'court_cases', 'crmNote'));
    }
    ...
    public function show(CrmNote $crmNote)
    {
        ...
        $crmNote->load('customer', 'court_case', 'notesAccounts');
