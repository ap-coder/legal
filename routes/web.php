...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Court Dates
    Route::delete('court-dates/destroy', 'CourtDateController@massDestroy')->name('court-dates.massDestroy');
    Route::post('court-dates/media', 'CourtDateController@storeMedia')->name('court-dates.storeMedia');
    Route::post('court-dates/ckmedia', 'CourtDateController@storeCKEditorImages')->name('court-dates.storeCKEditorImages');
    Route::resource('court-dates', 'CourtDateController');

    // Court Cases
    Route::delete('court-cases/destroy', 'CourtCaseController@massDestroy')->name('court-cases.massDestroy');
    Route::resource('court-cases', 'CourtCaseController');

    // Courthouses
    Route::delete('courthouses/destroy', 'CourthouseController@massDestroy')->name('courthouses.massDestroy');
    ...
    Route::post('attorneys/media', 'AttorneyController@storeMedia')->name('attorneys.storeMedia');
    Route::post('attorneys/ckmedia', 'AttorneyController@storeCKEditorImages')->name('attorneys.storeCKEditorImages');
