...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#client_court_cases" role="tab" data-toggle="tab">
                {{ trans('cruds.courtCase.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#client_accounts" role="tab" data-toggle="tab">
                {{ trans('cruds.account.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#client_court_dates" role="tab" data-toggle="tab">
                {{ trans('cruds.courtDate.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="client_court_cases">
            @includeIf('admin.crmCustomers.relationships.clientCourtCases', ['courtCases' => $crmCustomer->clientCourtCases])
        </div>
        <div class="tab-pane" role="tabpanel" id="client_accounts">
            @includeIf('admin.crmCustomers.relationships.clientAccounts', ['accounts' => $crmCustomer->clientAccounts])
        </div>
        <div class="tab-pane" role="tabpanel" id="client_court_dates">
            @includeIf('admin.crmCustomers.relationships.clientCourtDates', ['courtDates' => $crmCustomer->clientCourtDates])
        </div>
    </div>
</div>
