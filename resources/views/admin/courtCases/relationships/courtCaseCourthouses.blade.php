    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-courtCaseCourthouses">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.courthouse.fields.court_case') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($courthouses as $key => $courthouse)
                            <tr data-entry-id="{{ $courthouse->id }}">
                                ...
                                <td>
                                    {{ $courthouse->court_case->case_name ?? '' }}
                                </td>
                                <td>
                                    {{ $courthouse->court_case->case_number ?? '' }}
                                </td>
                                <td>
                                    @can('courthouse_show')
...
@endcan
  ...
  $('.datatable-courtCaseCourthouses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
