...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.courthouse.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.courthouses.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="courthouse_name">{{ trans('cruds.courthouse.fields.courthouse_name') }}</label>
                <input class="form-control {{ $errors->has('courthouse_name') ? 'is-invalid' : '' }}" type="text" name="courthouse_name" id="courthouse_name" value="{{ old('courthouse_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courthouse_street') ? 'is-invalid' : '' }}" type="text" name="courthouse_street" id="courthouse_street" value="{{ old('courthouse_street', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courthouse_street_2') ? 'is-invalid' : '' }}" type="text" name="courthouse_street_2" id="courthouse_street_2" value="{{ old('courthouse_street_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courthouse_city') ? 'is-invalid' : '' }}" type="text" name="courthouse_city" id="courthouse_city" value="{{ old('courthouse_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courthouse_state') ? 'is-invalid' : '' }}" type="text" name="courthouse_state" id="courthouse_state" value="{{ old('courthouse_state', 'Utah') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('courthouse_zip') ? 'is-invalid' : '' }}" type="text" name="courthouse_zip" id="courthouse_zip" value="{{ old('courthouse_zip', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('googlemaps_url') ? 'is-invalid' : '' }}" type="text" name="googlemaps_url" id="googlemaps_url" value="{{ old('googlemaps_url', '') }}">
